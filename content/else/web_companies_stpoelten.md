...
The quote flow
The contact form collects name, email, phone, and company size. On submit, two things happen in parallel: an immediate Slack-style notification email goes to the founders, and a QStash job is queued with a one-hour delay to send the personalised offer PDF to the lead. The delay is intentional — it feels less automated, more considered.
