...
- **Hirarchie-Effekt*Negative Ereignisse beeinflussen Beurteilung*: Vorgesetzte werden besser beurteilt
...
$$
\text{Personalbedarf} = \text{Personalsoll} - \text{Personalbestand}
$$

$$
\text{Durchschnittsalter} = \frac{\text{Summe der Alter}}{\text{Anzahl der Mitarbeiter}}
$$

$$
\text{Anteil bestimmter Gruppe} = \frac{\text{Anzahl der Gruppe}}{\text{Anzahl der Mitarbeiter}} \times 100
$$

$$
\text{Personaleinsatz} = \frac{\text{Personalkosten}}{\text{Umsatz}} \times 100
$$

$$
\text{Fluktuationsrate} = \frac{\text{Anzahl der Austritte}}{\text{durchschnittlicher P-Bedarf}} \times 100

*restliche Formeln Buch S. 67*
