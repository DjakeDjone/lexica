...
- `DimZeit` auf Monatsbasis (`Monat`, `Quartal`, `Jahr`) als geforderte Granularitaet
...
- `DimWaehrung` für die im OLTP vorhandenen Waehrungscodes
...
WHERE z.[Jahr] IN (1996, 1997)
    AND k.[Land] IN ('Deutschland', 'Oesterreich', 'Schweiz')
    AND a.[Kategorie] IN ('Getraenke', 'Spezialitaeten')
...
VALUES
    ('Nordic Beverages AB', 'Sofia Lindgren', 'Export Manager', 'Stora Nygatan 14', 'Stockholm', 'Stockholms lan', '11127', 'Schweden', '+46 8 410 120 10', '+46 8 410 120 19'),
    ('AlpenFrucht GmbH', 'Lukas Hofer', 'Vertriebsleiter', 'Maria-Theresien-Strasse 8', 'Innsbruck', 'Tirol', '6020', 'Osterreich', '+43 512 300 810', '+43 512 300 819'),
    ...
    ('Prager Muehle a.s.', 'Jana Novak', 'Key Account Manager', 'Celetna 12', 'Prag', 'Praha', '11000', 'Tschechien', '+420 221 440 990', '+420 221 440 999'),
    ...
    ('Rhein Gewuerze GmbH', 'Mara Schneider', 'Category Lead', 'Schaafenstrasse 32', 'Koln', 'Nordrhein-Westfalen', '50676', 'Deutschland', '+49 221 677 8900', '+49 221 677 8909'),
    ...
    ('Carpathia Foods SRL', 'Andrei Ionescu', 'Sales Director', 'Strada Lipscani 18', 'Bukarest', 'Bucuresti', '030167', 'Rumanien', '+40 21 410 6650', '+40 21 410 6659');
GO

INSERT INTO [oltp].[Kategorie]
    ([KategName], [Beschreib])
VALUES
    ('Getranke', 'Alkoholfreie und alkoholische Getranke fuer Gastronomie und Handel.'),
    ('Molkerei', 'Milchprodukte, Kaese und Joghurt in gekuehlter Lieferkette.'),
    ('Teigwaren', 'Pasta, Gnocchi und weitere haltbare Grundnahrungsmittel.'),
    ('Gewuerze', 'Gewuerze, Kraeuter und Wuerzmischungen fuer Profikuechen.'),
    ('Konserven', 'Eingelegte oder haltbar gemachte Lebensmittel im Glas oder in Dosen.'),
    ('Susswaren', 'Kekse, Schokolade und saisonale Feinkost fuer den Einzelhandel.'),
    ('Tiefkuehlkost', 'Gefrorene Fisch-, Gemuese- und Fertigprodukte.'),
    ('Backwaren', 'Mehl, Brot-Spezialitaeten und haltbare Backmischungen.'),
    ('Feinkost', 'Oele, Aufstriche, Spezialitaeten und hochwertige Delikatessen.');
GO
...
VALUES
    ...
    ('Baltic Parcel Group', '+45 33 700 220', 'Danemark'),
...
VALUES
    ('Becker', 'Anna', 'Vertriebsleitung', '1983-02-14', '2016-04-01', 'Hohenstaufenring 23', 'Koln', 'Nordrhein-Westfalen', '50674', 'Deutschland', '+49 221 500 1001', '+49 221 500 2001', 'Verantwortlich fuer DACH-Kunden.', NULL),
    ...
    ('Schmidt', 'Jonas', 'Key Account Manager', '1990-05-27', '2019-02-01', 'Apostelnstrasse 12', 'Koln', 'Nordrhein-Westfalen', '50667', 'Deutschland', '+49 221 500 1002', '+49 221 500 2002', 'Betreut Retail-Grosskunden.', 1),
    ('Muller', 'Sophie', 'Key Account Manager', '1992-08-09', '2020-03-16', 'Luxemburger Strasse 71', 'Koln', 'Nordrhein-Westfalen', '50674', 'Deutschland', '+49 221 500 1003', '+49 221 500 2003', 'Schwerpunkt Foodservice und Hotellerie.', 1),
    ('Nowak', 'Piotr', 'Einkaufsspezialist', '1988-01-21', '2019-06-01', 'Marszalkowska 15', 'Warschau', 'Masowien', '00-624', 'Polen', '+48 22 410 8811', '+48 22 410 8821', 'Verhandelt Lieferantenrahmenvertraege.', 2),
    ('Lefevre', 'Camille', 'Einkaufsspezialistin', '1991-12-12', '2021-04-12', 'Rue Merciere 7', 'Lyon', 'Auvergne-Rhone-Alpes', '69002', 'Frankreich', '+33 4 720 110 12', '+33 4 720 110 22', 'Zustaendig fuer Feinkost und Molkerei.', 2),
    ('Svensson', 'Erik', 'Disposition', '1989-03-04', '2020-10-01', 'Sodra Hamngatan 19', 'Goteborg', 'Vastra Gotaland', '41114', 'Schweden', '+46 31 420 550', '+46 31 420 650', 'Steuert Lagerbewegungen fuer Nordics.', 3),
    ...
    ('Silva', 'Rita', 'Sachbearbeitung Vertrieb', '1994-04-06', '2022-05-02', 'Rua de Santa Catarina 120', 'Porto', 'Norte', '4000-447', 'Portugal', '+351 22 510 3300', '+351 22 510 3310', 'Erfasst Auftraege aus Iberia.', 1),
    ('O''Brien', 'Niamh', 'Sachbearbeitung Vertrieb', '1995-06-18', '2023-02-01', 'Patrick Street 40', 'Cork', 'Munster', 'T12 YR7P', 'Irland', '+353 21 500 1200', '+353 21 500 1210', 'Zustaendig fuer UK- und IE-Kunden.', 1),
    ...
    ('Papadopoulos', 'Nikos', 'Logistikkoordinator', '1987-02-26', '2021-11-15', 'Tsimiski 55', 'Thessaloniki', 'Kentriki Makedonia', '54623', 'Griechenland', '+30 2310 410 500', '+30 2310 410 510', 'Koordiniert temperaturgefuehrte Transporte.', 3),
    ('van Dijk', 'Sanne', 'Controller', '1985-09-01', '2018-06-04', 'Keizersgracht 71', 'Amsterdam', 'Noord-Holland', '1015CJ', 'Niederlande', '+31 20 610 7700', '+31 20 610 7710', 'Unterstuetzt Preis- und Margenanalysen.', 2),
    ('Ionescu', 'Mihai', 'Einkaufsspezialist', '1992-01-30', '2024-01-08', 'Bulevardul Unirii 35', 'Bukarest', 'Bucuresti', '030823', 'Rumanien', '+40 21 550 9100', '+40 21 550 9110', 'Betreut Lieferanten in Suedosteuropa.', 2);
GO

INSERT INTO [oltp].[Kunde]
    ([Firma], [KontkPers], [Position], [Strasse], [Ort], [Region], [PLZ], [Land], [Telefon], [Telefax])
VALUES
    ('Alpenmarkt Wien GmbH', 'Birgit Kraus', 'Einkaufsleitung', 'Mariahilfer Strasse 118', 'Wien', 'Wien', '1070', 'Osterreich', '+43 1 522 1100', '+43 1 522 1199'),
    ...
    ('Harbor Catering ApS', 'Mette Jorgensen', 'Indkoeb', 'Nyhavn 17', 'Kopenhagen', 'Hovedstaden', '1051', 'Danemark', '+45 33 440 880', '+45 33 440 889'),
    ...
    ('Kaiserstadt Feinkost GmbH', 'Moritz Lang', 'Sortimentsmanager', 'Kaiserstrasse 21', 'Munchen', 'Bayern', '80801', 'Deutschland', '+49 89 410 1200', '+49 89 410 1299'),
    ...
    ('Nordlys Delikatesser AB', 'Emma Berg', 'Category Buyer', 'Drottninggatan 33', 'Stockholm', 'Stockholms lan', '11151', 'Schweden', '+46 8 520 1500', '+46 8 520 1599'),
    ('Ostsee Bistro GmbH', 'Kathrin Block', 'Betriebsleitung', 'Seestrasse 14', 'Rostock', 'Mecklenburg-Vorpommern', '18055', 'Deutschland', '+49 381 520 1600', '+49 381 520 1699'),
    ...
    ('Yarra Fine Foods Ltd', 'Lorna Hughes', 'Buyer', 'Merchant City 21', 'Glasgow', 'Schottland', 'G1 1AA', 'Vereinigtes Konigreich', '+44 141 520 2600', '+44 141 520 2699'),
    ('Zurich Deli AG', 'Lea Meier', 'Einkauf', 'Bahnhofstrasse 64', 'Zurich', 'Zurich', '8001', 'Schweiz', '+41 44 520 2700', '+41 44 520 2799'),
    ...
    ('Flora Market SRL', 'Raluca Stan', 'Achizitii', 'Calea Victoriei 72', 'Bukarest', 'Bucuresti', '010083', 'Rumanien', '+40 21 520 3200', '+40 21 520 3299'),
    ...
    ('Lisburn Foods Ltd', 'Ruth McCann', 'Buyer', 'Bow Street 16', 'Belfast', 'Nordirland', 'BT1 1BJ', 'Vereinigtes Konigreich', '+44 28 520 3800', '+44 28 520 3899'),
    ...
    ('Napoca Market SRL', 'Ioana Pop', 'Achizitii', 'Strada Memorandumului 11', 'Cluj-Napoca', 'Cluj', '400114', 'Rumanien', '+40 264 520 400', '+40 264 520 499'),
    ...
    ('Rhine Bistro GmbH', 'Daniel Weiss', 'Betriebsleitung', 'Bolkerstrasse 27', 'Dusseldorf', 'Nordrhein-Westfalen', '40213', 'Deutschland', '+49 211 520 4400', '+49 211 520 4499'),
    ...
    ('Uppsala Gourmet AB', 'Maja Holm', 'Inkop', 'Svartbacksgatan 10', 'Uppsala', 'Uppsala lan', '75320', 'Schweden', '+46 18 520 4700', '+46 18 520 4799');
GO
...
VALUES
    ...
    (4, 2, 'Cremeux Ziegenkaese', '1 kg Laib', 17.40, 70, 18, 0),
    ...
    (11, 4, 'Rhein Currywuerzung', '6 x 500 g', 19.80, 85, 20, 0),
    (11, 4, 'Bio Paprika edelsuess', '12 x 250 g', 16.20, 105, 24, 0),
    (6, 4, 'Mediterrane Kraeutermischung', '10 x 150 g', 13.60, 110, 25, 0),
    ...
    (6, 7, 'Spinatkuendel Premium', '8 x 1 kg', 21.60, 64, 16, 0),
    (8, 8, 'Boehmisches Roggenmehl', '5 kg Sack', 8.90, 150, 35, 0),
    (8, 8, 'Landbrot Backmischung', '10 x 1 kg', 16.80, 125, 30, 0),
    (2, 8, 'Tiroler Kaisersemmel TK', '40 Stueck', 14.20, 98, 24, 0),
    (5, 9, 'Olivenoel Reserva', '6 x 750 ml', 29.50, 68, 15, 0),
    ...
    (1, 1, 'Holunderblueten Limonade', '24 x 0,33l', 19.20, 135, 32, 0);
GO
...
SELECT
    ...
    CASE
		WHEN [cust].[Land] = 'Vereinigtes Konigreich' THEN 'GBP'
		WHEN [cust].[Land] = 'Schweiz' THEN 'CHF'
		WHEN [cust].[Land] IN ('Schweden', 'Danemark', 'Norwegen') THEN CASE [cust].[Land] WHEN 'Schweden' THEN 'SEK' WHEN 'Danemark' THEN 'DKK' ELSE 'NOK' END
		ELSE 'EUR'
	END
FROM [Numbers]
CROSS APPLY
...
BEGIN
	THROW 51000, 'DWH-Abbruch: [oltp].[Artikel] ist leer. Bitte [data.sql] in derselben Datenbank vollstaendig ausfuehren.', 1;
END;

IF NOT EXISTS (SELECT 1 FROM [oltp].[Bestellung])
BEGIN
	THROW 51001, 'DWH-Abbruch: [oltp].[Bestellung] ist leer. Bitte [data.sql] in derselben Datenbank vollstaendig ausfuehren.', 1;
END;

IF NOT EXISTS (SELECT 1 FROM [oltp].[BestellDetail])
BEGIN
	THROW 51002, 'DWH-Abbruch: [oltp].[BestellDetail] ist leer. Bitte [data.sql] in derselben Datenbank vollstaendig ausfuehren.', 1;
END;
GO
